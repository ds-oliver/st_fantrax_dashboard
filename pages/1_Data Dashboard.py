...
def main():
    ...
    with st.sidebar:
        selected_df_name = option_menu("Select DataFrame", dfs_titles, icons=dfs_icons, menu_icon="list", styles=default_style)

    selected_frames = df_dict.get(selected_df_name, {}).get('frames', [])
