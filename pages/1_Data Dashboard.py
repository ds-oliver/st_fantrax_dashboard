        ...
        f"Recent GW Data (GW {recent_gw})": {
            "frames": [
                ...
                },
                {
                    ...
                    "upper_info_text": f"Aggregated data is pre-filtered to for player data in matches were they played more than 45 minutes",
                },
            ],
            ...
            "frames": [
                {
                    ...
                    "info_text": f"Aggregated data is pre-filtered to for player data in matches were they played more than 45 minutes",
                    "drop_cols": [
                        "gp",
                        "gp (max)",
                        "gp (mean)",
