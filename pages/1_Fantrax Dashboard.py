...
def main():
    ...
    st.info("Note: The above table is a subset of the full player data, filtered to show only players who have played in the most recent gameweek. If HeatStreak values are missing, it means there was insufficient data over the last 3 gameweeks to calculate a value.")
